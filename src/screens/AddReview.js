    ...
    return (
      <KeyboardAwareScrollView style={{ flex: 1, backgroundColor: "#FFF" }}>
        <View style={styles.root}>
          ...
          {this.state.submitting && <ActivityIndicator size="large" color="#0066CC" style={{ padding: 10 }} />}

          <TouchableOpacity style={styles.submitButton} onPress={this.submitReview} disabled={this.state.submitting}>
